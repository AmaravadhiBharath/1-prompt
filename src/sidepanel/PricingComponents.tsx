...
export function UpgradePrompt({ currentTier, onSignIn, onUpgradeToPro, onClose }: UpgradePromptProps) {
      ...
      <div className="upgrade-modal">
        <div className="upgrade-content">
          ...
          <div className="upgrade-header">
            ...
            <p>You're on Basic. Sign in to get <b>Unlimited Captures</b> and more for FREE!</p>
          </div>
          ...
          <button className="kb-google-btn" onClick={onSignIn} style={{ width: '100%', marginTop: 8 }}>
        ...
        <div className="upgrade-content">
          ...
          <div className="upgrade-header">
            ...
            <div className="pricing-display">
              <span className="price-new">${PRO_PRICING.regularPrice}/month</span>
            </div>
          ...
          <div className="upgrade-features" style={{ margin: '24px 0' }}>
            <div className="feature-item">
              <span className="feature-icon">⚡</span>
              <span><b>Unlimited</b> session compiles</span>
            </div>
            <div className="feature-item">
              <span className="feature-icon">🧠</span>
          ...
          <button className="kb-btn-primary" onClick={onUpgradeToPro} style={{ width: '100%', padding: '12px', height: '48px' }}>
            Upgrade to Pro
          </button>
