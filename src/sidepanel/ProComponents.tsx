...
export function GenerateMode2({
  ...
  const templates = {
    creative: {
      ...
      instruction:
        "Enhance these prompts to be more creative, detailed, and engaging while preserving their core intent.",
    },
    technical: {
      name: "⚙️ Technical Precision",
      description: "Optimize for technical accuracy and clarity",
      instruction:
        "Refine these prompts for maximum technical precision, clarity, and actionable outcomes.",
    },
    business: {
      name: "💼 Business Focus",
      description: "Adapt for business and professional use",
      instruction:
        "Transform these prompts into professional, business-oriented requests with clear objectives and deliverables.",
    },
    educational: {
      name: "📚 Educational Style",
      description: "Structure for learning and teaching",
      instruction:
        "Restructure these prompts for educational purposes, focusing on learning objectives and step-by-step guidance.",
    },
  };
    ...
    <div className="generate-mode2-modal">
      <div className="generate-mode2-content">
        <div className="generator-header">
          ...
          <button className="generator-close" onClick={onClose}>
            ×
          </button>
        </div>
