...
const BUNDLED_CONFIG: Config = {
    backend: {
        url: (import.meta as any).env.VITE_BACKEND_URL || "https://1prompt-backend.amaravadhibharath.workers.dev",
    },
    features: {
    ...
    analytics: {
        ...
        posthogHost: (import.meta as any).env.VITE_POSTHOG_HOST || "https://us.i.posthog.com",
    },
    email: {
        resendKey: (import.meta as any).env.VITE_RESEND_API_KEY || "",
    },
    ai: {
        defaultProvider: (import.meta as any).env.VITE_DEFAULT_AI_PROVIDER || "auto",
