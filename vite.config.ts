...
const postBuildPlugin = () => ({
  ...
  closeBundle() {
    ...
    if (existsSync(srcHtmlPath)) {
      ...
      html = html.replace(/href="\.\.\/\.\.\/modulepreload-polyfill\.js"/g, 'href="../modulepreload-polyfill.js"');
      html = html.replace(/href="\.\.\/\.\.\/vendor\.js"/g, 'href="../vendor.js"');
      html = html.replace(/href="\.\.\/\.\.\/preload-helper\.js"/g, 'href="../preload-helper.js"');
      html = html.replace(/href="\.\.\/\.\.\/firebase\.js"/g, 'href="../firebase.js"');
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'welcome-sidepanel': resolve(__dirname, 'src/sidepanel/welcome-v2.html'),
